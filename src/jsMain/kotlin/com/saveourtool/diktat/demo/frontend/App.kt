...
package com.saveourtool.diktat.demo.frontend

import com.saveourtool.diktat.demo.frontend.components.EditorForm
import com.saveourtool.diktat.demo.frontend.utils.setupAceEditor
...
fun main() {
    ...
    render(document.getElementById("footer")) {
        p("text-center") {
            ...
            a(href = "https://github.com/saveourtool/diktat-demo") { +"here" }
            br { }
